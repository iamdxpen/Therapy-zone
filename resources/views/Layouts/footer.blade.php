...
<footer class="bg-dark footer-top">
    <div class="container pt-md-10 pt-20 pb-5">
        <div class="row gy-6 mb-6 gx-xl-12">
            ...
            <div class="col-xl-2 col-md-6">
                <p class="text-primary font-bold mb-4">Company</p>
                <a class="d-block mb-2 text-gray-300 text-hover-primary" href="{{route('home')}}">Home</a>
                <a class="d-block mb-2 text-gray-300 text-hover-primary" href="{{route('about-us')}}">About Us</a>
                <a class="d-block mb-2 text-gray-300 text-hover-primary" href="{{route('services')}}">Services</a>
                <a class="d-block mb-2 text-gray-300 text-hover-primary">Appointments</a>
                <a class="d-block text-gray-300 text-hover-primary " href="#">Contact Us</a>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="footer-social-links d-flex gap-3">
                    <a href="#" class="w-10 h-10 rounded-circle bg-light bg-hover-primary hstack justify-content-center"
                    ...
                    <a href="#" class="w-10 h-10 rounded-circle bg-light bg-hover-primary hstack justify-content-center"
                        target="_blank">
                        <i class="bi bi-skype text-black"></i>
                    </a>
                </div>
            </div>
        </div>
...
<footer class="bg-dark footer-bottom">
    <div class="container border-top border-gray-800">
        <p class="text-sm text-gray-500 py-4">© {{ date('Y') }} Therapy Zone. All rights reserved.</p>
    </div>
</footer>
<!-- Footer -->