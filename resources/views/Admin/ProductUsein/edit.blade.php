...
<div class="page-content">
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Update ProductUseIn</li>
                        </ol>
                    </div>
        ...
        {{ Form::open(['route' => ['admin.product.usein.update', ['id' => $productObj->id]], 'id' => 'productTypeFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update ProductUseIn</h4>
                    </div>
                    <div class="card-body">
