                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.spa.packages.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add Spa</a>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    $(function(){
      'use strict'
         var oTable = $('#spaTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.spa.packages.ajax-list') }}", 
             "aaSorting": [ [5, "desc"] ],  
    ...
    $(document).on('click','.spa_remove', function(){
        ...
        $(document).on('click','.spa_active', function(){
            var idStr = $(this).data('id');
            Swal.fire({
                title: "Are you sure?",
        ...
        $(document).on('click','.spa_inactive', function(){
            var idStr = $(this).data('id');
            Swal.fire({
                title: "Are you sure?",
    ...
    function statusChange(oTable, id, val)
    {
        ...
        setTimeout(() => {
            $.ajax({
                url: "{{ route('admin.spa.packages.update-status') }}",
    ...
    function removeSpa(oTable, id)
    {
        ...
        setTimeout(() => {
            $.ajax({
                url: "{{ route('admin.spa.packages.remove') }}",
