                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.customer.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add Customer</a>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    $(function(){
      'use strict'
         var oTable = $('#customerTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.customer.ajax-list') }}", 
             "aaSorting": [ [5, "desc"] ],  
