                        ...
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="alert alert-danger mb-2 mx-2" role="alert">{{ Session::get('error') }}</div>
                                    @endif
            
                                    @if(Session::has('success'))
                                    <div class="alert alert-success mb-2 mx-2" role="alert">{{ Session::get('success') }}</div>
                                    @endif

                                    @foreach ($errors->all() as $error)
                                    <div class="alert alert-danger mb-2 mx-2" role="alert">{!! $errors->first() !!}</div>
                                    @endforeach

                                    <div class="p-2">

                                        {{ Form::open(['route' => 'admin.login.do', 'id' => 'loginFrom', 'data-parsley-validate', 'autocomplete' => 'off']) }}
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    {{Form::password('password',['class' => 'form-control pe-5', 'placeholder' => 'Enter password', 'id' => 'password', 'required'])}}
