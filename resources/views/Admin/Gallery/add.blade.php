...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{ Form::open(['route' => 'admin.gallery.store', 'id' => 'galleryFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Add New Gallery</h4>
                    </div>
                    <div class="card-body">
