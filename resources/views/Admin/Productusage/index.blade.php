...
@section('page-title', 'ProductUsage Management')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">ProductUsage Management</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboards</a></li>
                            <li class="breadcrumb-item active">ProductUsage Management</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">List all ProductUsage</h5>
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.product.usage.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add ProductUsage</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="productUsageTable" class="display table table-bordered dt-responsive dataTable dtr-inline" style="width:100%">
                            <thead>
...
<script>
    $(function(){
      'use strict'
         var oTable = $('#productUsageTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.product.usage.ajax-list') }}", 
             "aaSorting": [ [3, "desc"] ],  
        ...
        $(document).on('click','.product_remove', function(){
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "This product type is not display after this action!",
                    icon: "warning",
                    showCancelButton: !0,
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This product type user able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(document).on('click','.product_active', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This product type not able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        function statusChange(oTable, id, val)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.usage.update-status') }}",
        ...
        function removeEnquiry(oTable, id)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.usage.remove') }}",
