...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{ Form::open(['route' => ['admin.logo.update', ['id' => $logo->id]], 'id' => 'silderFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Logo</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    {{Form::text('title',$logo->title, ['class' => 'form-control', 'placeholder' => 'Enter Title', 'id' => 'title', 'required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    {{Form::select('status', $status, $logo->status,['class' => 'form-select', 'required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="display_order" class="form-label">Display Order </label>
                                    {{Form::text('display_order', $logo->display_order, ['class' => 'form-control', 'placeholder' => 'Enter Display Order', 'id' => 'diamondrate','data-parsley-display_order'=>"true", 'data-parsley-display_order-message'=>"Display Order Number Already Taken"])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="image" class="form-label">Image </label>
                                    ...
                                    <a href="{{ get_image_url($logo->image) }}"> View Image </a>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                <label for="webp_image" class="form-label">Webp Image </label>
                                    ...
                                    <a href="{{ get_image_url($logo->webp_image) }}"> View Webp Image </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
