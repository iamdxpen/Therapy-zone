...
@section('page-title', 'ProductUseType Management')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">ProductUseType Management</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboards</a></li>
                            <li class="breadcrumb-item active">ProductUseType Management</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">List all ProductUseType</h5>
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.product.usetype.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add ProductUseType</a>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    $(function(){
      'use strict'
         var oTable = $('#productTypeTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.product.usetype.ajax-list') }}", 
             "aaSorting": [ [3, "desc"] ],  
        ...
        function statusChange(oTable, id, val)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.usetype.update-status') }}",
        ...
        function removeEnquiry(oTable, id)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.usetype.remove') }}",
