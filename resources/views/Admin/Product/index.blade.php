            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">List all Product</h5>
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.product.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add Product</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="productTable" class="display table table-bordered dt-responsive dataTable dtr-inline" style="width:100%">
                            <thead>
...
<script>
    $(function(){
      'use strict'
         var oTable = $('#productTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.product.ajax-list') }}", 
             "aaSorting": [ [4, "desc"] ],  
    ...
    $(document).on('click','.product_remove', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This Product is not display after this action!",
                icon: "warning",
                showCancelButton: !0,
        ...
        $(document).on('click','.product_active', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This Product not able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(document).on('click','.product_inactive', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This Product able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
    ...
    function removeProduct(oTable, id)
    {
        $('.vertical-overlay').show();
        setTimeout(() => {
            $.ajax({
                url: "{{ route('admin.product.remove') }}",
