            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">List all users</h5>
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.users.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add User</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="userTable" class="display table table-bordered dt-responsive dataTable dtr-inline" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
    ...
    $(function(){
      'use strict'
        var oTable = $('#userTable').DataTable({
            "processing": true,
            "bServerSide": true,
            "sAjaxSource": "{{ route('admin.users.ajax-list') }}",
            "aaSorting": [ [5, "desc"] ],
        ...
        $(document).on('click','.user_active', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This user not able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
        ...
        $(document).on('click','.user_inactive', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This user able to login after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(document).on('click','.user_remove', function(){
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This user is not display after this action!",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
