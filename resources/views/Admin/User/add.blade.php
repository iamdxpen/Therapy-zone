...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{ Form::open(['route' => 'admin.users.store', 'id' => 'userFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    {{Form::email('email', '', ['class' => 'form-control', 'placeholder' => 'Enter email address', 'id' => 'email', 'required', 'data-parsley-email'=>"true", 'data-parsley-email-message'=>"Please provide a unique email"])}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    {{Form::select('role', $roles, '',['class' => 'form-select', 'required', 'placeholder' => 'Please select role'])}}
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div>
                                    <label for="password" class="form-label">New Password <span class="text-danger">*</span></label>
                                    {{Form::password('password', ['class' => 'form-control', 'placeholder' => 'Enter new password', 'id' => 'password', 'required'])}}
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div>
