                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ProductType Management</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1">List all ProductType</h5>
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.product.type.add')}}" class="btn btn-primary btn-label"><i class=" ri-add-line label-icon align-middle fs-16 me-2"></i> Add ProductType</a>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    $(function(){
      'use strict'
         var oTable = $('#productTypeTable').DataTable({
            "processing": true,
             "bServerSide": true,
             "sAjaxSource": "{{ route('admin.product.type.ajax-list') }}", 
             "aaSorting": [ [3, "desc"] ],  
        ...
        function statusChange(oTable, id, val)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.type.update-status') }}",
        ...
        function removeEnquiry(oTable, id)
        {
            ...
            setTimeout(() => {
                $.ajax({
                    url: "{{ route('admin.product.type.remove') }}",
