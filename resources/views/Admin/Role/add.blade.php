...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{ Form::open(['route' => 'admin.roles.store', 'id' => 'roleFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="mb-3">
                                    ...
                                    {{Form::text('name', '', ['class' => 'form-control', 'placeholder' => 'Enter role name', 'id' => 'name', 'required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
