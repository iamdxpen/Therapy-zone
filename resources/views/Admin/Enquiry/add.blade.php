...
<div class="page-content">
    <div class="container-fluid">
        ...
        {{ Form::open(['route' => 'admin.enquiry.store', 'id' => 'enquiryFrom', 'data-parsley-validate', 'files' => true, 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Add New Enquiry</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    {{Form::number('phone', '', ['class' => 'form-control', 'placeholder' => 'Enter Phone', 'id' => 'phone', 'required'])}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    {{Form::select('country', $country, '',['class' => 'form-select', 'placeholder' => '-please select-','required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="city" class="form-label">City<span class="text-danger">*</span></label>
                                    {{Form::text('city', '', ['class' => 'form-control', 'placeholder' => 'Enter City', 'id' => 'city', 'required'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    {{Form::select('subject', $subject, '',['class' => 'form-select', 'placeholder' => '-please select-', 'required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    {{Form::select('product', $product, '',['class' => 'form-select', 'placeholder' => '-please select-','required'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="product_other" class="form-label">Product Other </label>
                                    {{Form::text('product_other', '', ['class' => 'form-control', 'placeholder' => 'Enter Product other', 'id' => 'product_other'])}}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="organization" class="form-label">Organization<span class="text-danger">*</span></label>
                                    {{Form::text('organization', '', ['class' => 'form-control', 'placeholder' => 'Enter Organization', 'id' => 'organization','required'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    {{Form::textarea('comments', '', ['class' => 'form-control', 'placeholder' => 'Enter Comments', 'id' => 'comments'])}}
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
