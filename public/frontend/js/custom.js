 ...
 */
$("#requestAQouteForm").submit(function (event) {
  event.preventDefault();
  $(".print-error-msg").hide();
  $(".requestaquoteSubmit").prop("disabled", true);
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        $("#requestAQouteForm")[0].reset();
        $("#request-a-qoute-form-file-preview").text(
            "Drag Images or browser to upload (Optional)"
        );
        $("#requestaquoteSubmit").prop("disabled", false);
        $(".spinner").removeClass(
            "spinner-border text-light w-4 h-4 mx-2"
        );
        $(".request-a-quote-message").removeClass("d-none");
        $(".request-a-quote-message").addClass("text-success");
        $(".request-a-quote-message").text(data.message);
        setTimeout(() => {
            window.location.href = thankYouPageUrl;
            $(".request-a-quote-message").addClass("d-none");
        }, 1000);
      } else {
        $(".request-a-quote-message").removeClass("text-primary");
        $(".request-a-quote-message").addClass("text-danger");
        $(".request-a-quote-message").text(data.message);
        $("#requestaquoteSubmit").prop("disabled", false);
        $(".spinner").removeClass(
            "spinner-border text-light w-4 h-4 mx-2"
...
/**
 * applay for job form submit
 */
$("#applay-for-job").submit(function (event) {
  event.preventDefault();
  $(".print-error-msg").hide();
  $(".requestaquoteSubmit").prop("disabled", true);
  $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        ...
        $("#applay-for-job-file-preview").text(
            "Drag Images or browser to upload (Optional)"
        );
        ...
        $(".request-a-quote-message").removeClass("text-success");
        $(".request-a-quote-message").addClass("text-danger");
        $(".request-a-quote-message").text(data.message);
        $("#candidateSubmit").prop("disabled", false);
        $(".spinner").removeClass(
 ...
 * applay for job form submit
 */
$("#hire-our-resources").submit(function (event) {
  event.preventDefault();
  $(".print-error-msg").hide();
  $(".requestaquoteSubmit").prop("disabled", true);
  $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        $("#hire-our-resources")[0].reset();
        $("#hire-our-resources-file-preview").text(
            "Drag Images or browser to upload (Optional)"
        );
        $("#hireOurResourcesSubmit").prop("disabled", false);
        $(".spinner").removeClass(
            "spinner-border text-light w-4 h-4 mx-2"
        );
        $(".request-a-quote-message").removeClass("d-none");
...
$(".testimonial-slider").slick({
  ...
  arrows: true,
  speed: 300,
  prevArrow: "#next-event-carousel-previous",
  nextArrow: "#next-event-carousel-next",
  responsive: [
    {
      breakpoint: 1200,
      settings: {
...
/**
 * about us page techvoot-employee-slide
 */
$(".techvoot-employee-slide").slick({
  dots: false,
  arrows: false,
  slidesToShow: 3.1,
  slidesToScroll: 1,
 ...
 * Testimonial Slider
 */
$(".e-commerce-development-slider").slick({
  dots: true,
  infinite: false,
  slidesToShow: 3,
  slidesToScroll: 1,
...
$(".portfolio-main-laptop-featuring").hover(
  function () {
    var laptopsInner = $(this).find(".laptop-inner");
    laptopsInner.each(function () {
      var imageHeight = $(this).find(".scroll-section").height();
      var laptopHeight = $(this).height();
      var scrollHeight = imageHeight - laptopHeight;
      $(this)
          .find(".scroll-section")
          .css("transform", "translate3d(0, -" + scrollHeight + "px, 0)");
      // $(this).find("img").css("transform", "translate3d(0, -" + scrollHeight + "px, 0)");
    });
    $(this).find(".light-effect").css("opacity", 1);
  },
  function () {
    var laptopsInner = $(this).find(".laptop");
    laptopsInner.each(function () {
      $(this)
          .find(".scroll-section")
          .css("transform", "translate3d(0, 0, 0)");
    });
    $(this).find(".light-effect").css("opacity", "");
  }
);

$(".portfolio-main-mobile-featuring").hover(
  function () {
    var laptopsInner = $(this).find(".mobile-inner");
    laptopsInner.each(function () {
      var imageHeight = $(this).find(".scroll-section").height();
      var laptopHeight = $(this).height();
      var scrollHeight = imageHeight - laptopHeight;
  ...
  function () {
    var laptopsInner = $(this).find(".mobile-slide");
    laptopsInner.each(function () {
      $(this)
          .find(".scroll-section")
          .css("transform", "translate3d(0, 0, 0)");
...
// container side
jQuery(function () {
  if (jQuery(".section-one-side")[0]) {
    var left_value = $(".section-one-side").offset().left + 12;
    $(".section-one-side-img").css("margin-right", "-" + left_value + "px");
    $(window).resize(function () {
      var left_value = $(".section-one-side").offset().left + 12;
      $(".section-one-side-img").css(
          "margin-right",
          "-" + left_value + "px"
      );
    });
  ...
  .scroll(function () {
    ...
    $(".page-section").each(function (i) {
      if ($(this).position().top <= scrollDistance) {
          $(
              ".sidebar-blog-timeline .blog-timeline-link.active"
          ).removeClass("active");
          $(".sidebar-blog-timeline .blog-timeline-link")
              .eq(i)
              .addClass("active");
      }
    });
...
$('button[data-bs-toggle="pill"]').on("shown.bs.tab", function (e) {
  $(".print-error-msg").hide();
  $("#hire-our-resources").trigger("reset");
  $("#requestAQouteForm").trigger("reset");
  $("#applay-for-job").trigger("reset");
});

/**
 * Image upload on change.
 */
$("#request-a-qoute-form-file").change(function (e) {
  var filename = e.target.files[0].name;
  $("#request-a-qoute-form-file-preview").text(filename);
});
$("#connect-with-our-experts").change(function (e) {
    var filename = e.target.files[0].name;
    $("#connect-with-our-experts-preview").text(filename);
  });

$("#applay-for-job-file").change(function (e) {
  var filename = e.target.files[0].name;
  $("#applay-for-job-file-preview").text(filename);
});

$("#hire-our-resources-file").change(function (e) {
  var filename = e.target.files[0].name;
  $("#hire-our-resources-file-preview").text(filename);
});

$("#blog-contact-form").submit(function (event) {
  event.preventDefault();
  $(".print-error-msg").hide();
  $(".blog-contact-btn").prop("disabled", true);
  $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
  let form = $(this);
  let url = form.attr("action");
  let form_data = new FormData(this);
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        $("#blog-contact-form")[0].reset();
        toastr.success(data.message);
        $(".blog-contact-btn").prop("disabled", false);
        window.location.href = thankYouPageUrl;
        $(".spinner").removeClass(
          "spinner-border text-light w-4 h-4 mx-2"
        );
      } else {
        $(".request-a-blog-contact").removeClass("text-primary");
        $(".request-a-blog-contact").addClass("text-danger");
        $(".request-a-blog-contact").text(data.message);
      }
    },
    error: function (data) {
      $.each(data.responseJSON.errors, function (key, value) {
...
$("#contact-us-from-area-we-serve").submit(function (event) {
  event.preventDefault();
  $(".print-error-msg").hide();
  $(".area-we-serve-contact-btn").prop("disabled", true);
  $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
  let form = $(this);
  let url = form.attr("action");
  let form_data = new FormData(this);
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        $("#contact-us-from-area-we-serve")[0].reset();
        toastr.success(data.message);
        $(".area-we-serve-contact-btn").prop("disabled", false);
        window.location.href = thankYouPageUrl;
        $(".spinner").removeClass(
            "spinner-border text-light w-4 h-4 mx-2"
        );
      } else {
        $(".request-a-area-we-serve-contact").removeClass(
            "text-primary"
        );
        $(".request-a-area-we-serve-contact").addClass("text-danger");
        $(".request-a-area-we-serve-contact").text(data.message);
      }
    },
    error: function (data) {
      $.each(data.responseJSON.errors, function (key, value) {
...
// Twitter url
$("body").on("click", ".twitterBtn", function (e) {
  e.preventDefault();
  var link = $(".share-btn").data("url");
  var twitterUrl = $(this).attr("data-href") + link;
  window.open(twitterUrl, "_blank");
});

// Linkdin url
$("body").on("click", ".linkdinBtn", function (e) {
  e.preventDefault();
  var link = $(".share-btn").data("url");
  var linkdinUrl = $(this).attr("data-href") + link;
  window.open(linkdinUrl, "_blank");
});

// Facebook url
$("body").on("click", ".facebookBtn", function (e) {
  e.preventDefault();
  var link = $(".share-btn").data("url");
  var facebookUrl = $(this).attr("data-href") + link;
  window.open(facebookUrl, "_blank");
});

$("#news-letter-form").submit(function (event) {
  event.preventDefault();
  $("#newsLetterbtnSumbit").prop("disabled", true);
  $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
  let form = $(this);
  let url = form.attr("action");
  let form_data = new FormData(this);
  $.ajax({
    ...
    success: function (data) {
      if (data.status == true) {
        ...
        $("#newsLetterbtnSumbit").prop("disabled", false);
        $("#subscribe_thank_you_modal").modal("show");
      } else {
        $(".request-a-blog-contact").text(data.message);
      }
    },
...
$("body").on("click", "#thank_you_ok_btn", function (e) {
  window.location.reload();
});

/**
 * Free consultation form submit
 */
$("#freeConsultationForm").submit(function (event) {
    event.preventDefault();
    $(".print-error-msg").hide();
    $(".freeConsultationBtn").prop("disabled", true);
    $(this).find(".spinner").addClass("spinner-border text-light w-4 h-4 mx-2");
    let form = $(this);
    let url = form.attr("action");
    let form_data = new FormData(this);
    $.ajax({
      ...
      success: function (data) {
        if (data.status == true) {
          $("#freeConsultationForm")[0].reset();
          $("#connect-with-our-experts-preview").text(
              "Drag Images or browser to upload (Optional)"
          );
          $("#freeConsultationSubmit").prop("disabled", false);
          $(".spinner").removeClass(
              "spinner-border text-light w-4 h-4 mx-2"
          );
          $(".request-a-quote-message").removeClass("d-none");
          ...
          $(".request-a-quote-message").addClass("text-danger");
          $(".request-a-quote-message").text(data.message);
          $(".freeConsultationBtn").prop("disabled", false);
          $(".spinner").removeClass(
              "spinner-border text-light w-4 h-4 mx-2"
          );
        }
